...
type SumRequest struct {
	...
	FirstNumber   int32                  `protobuf:"varint,10,opt,name=first_number,json=firstNumber,proto3" json:"first_number,omitempty"`
	SecondNumber  int32                  `protobuf:"varint,7,opt,name=second_number,json=secondNumber,proto3" json:"second_number,omitempty"`
...
const file_sum_proto_rawDesc = "" +
	...
	"SumRequest\x12!\n" +
	"\ffirst_number\x18\n" +
	" \x01(\x05R\vfirstNumber\x12#\n" +
	"\rsecond_number\x18\a \x01(\x05R\fsecondNumber\"%\n" +
	"\vSumResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x05R\x06resultB0Z.github.com/Omar-Sa6ry/grpc-go/calculator/protob\x06proto3"
