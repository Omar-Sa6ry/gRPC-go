...
const file_greet_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\tR\x06result2\xc5\x02\n" +
	"\fGreetService\x124\n" +
	"\x05Greet\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00\x12?\n" +
	"\x0eGreetManyTimes\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x000\x01\x12:\n" +
	"\tLongGreet\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00(\x01\x12@\n" +
	"\rGreetEveryone\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00(\x010\x01\x12@\n" +
	"\x11GreetWithDeadline\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00B+Z)github.com/Omar-Sa6ry/grpc-go/greet/protob\x06proto3"
