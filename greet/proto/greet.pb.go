...
const file_greet_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\tR\x06result2D\n" +
	"\fGreetService\x124\n" +
	"\x05Greet\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00B+Z)github.com/Omar-Sa6ry/grpc-go/greet/protob\x06proto3"
